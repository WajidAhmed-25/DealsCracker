...
//                 <h5 class="mb-0 wow bounceInLeft">Best Deals Todays</h5>
...
// ____________________________________ Mapping Data _____________________________________________________
...
const productData = [
  {
    ...
    imgSrc: "assets/images/thumbs/product-img8.png",
  ...
  },
  {
    id: 2,
    badge: { text: "Sale 50%", color: "bg-danger-600" },
    imgSrc: "assets/images/thumbs/product-img9.png",
  ...
  },
  {
    ...
    imgSrc: "assets/images/thumbs/product-img10.png",
  ...
  },
  {
    ...
    imgSrc: "assets/images/thumbs/product-img18.png",
      ...
      <div className="container container-lg">
        <div className="section-heading">
          <div className="flex-between flex-wrap gap-8">
            <h5 className="mb-0 wow bounceInLeft">Best Deals Today</h5>
